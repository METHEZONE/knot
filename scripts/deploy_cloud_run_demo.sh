...
WEB3_SIGNING_MODE="${KNOT_WEB3_SIGNING_MODE:-testnet}"
SOLANA_CLUSTER="${SOLANA_CLUSTER:-testnet}"
SOLANA_RPC_URL="${SOLANA_RPC_URL:-https://api.testnet.solana.com}"
KNOT_ESCROW_NETWORK="${KNOT_ESCROW_NETWORK:-solanaTestnet}"
