...
| D8 | **가입 시 지갑은 계속 만들어 준다.** 단 **유저가 소유하는** 논커스터디얼 지갑이다. "web3 몰라도 쓸 수 있다" 는 제품 전제를 포기하지 않는다 (§P9.2) |
...
| 0b | **D8 유저 소유 지갑 생성** (클라이언트 키 생성 + 키 내보내기) | 제공자 선정 | `.agent/execplans/user-owned-wallet.md` |
...
|---|---|
| 오프램프 파트너 (P5) | 외부 계약 |
| D8 지갑 제공자 선정 (§P9.2) | Solana 지원 + **복구 조각을 우리가 갖지 않는 구성** 확인 후 결정. §P9.1 의 경로 1·3 만으로도 D7 은 성립하므로 **착수를 막지 않는다** |
