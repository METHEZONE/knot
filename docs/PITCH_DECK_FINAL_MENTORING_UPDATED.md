...
> **Implementation Update (2026-08-19):** 실제 구현은 2단계 마일스톤 시스템(20% deposit + 80% content)으로 통합되었습니다. 72시간 타임락과 분쟁 시스템은 content 마일스톤에 적용됩니다.
...
3. **2단계 에스크로 + 타임락** - 20% 계약금 + 72시간 분쟁 기간 + 80% 최종 정산
4. **분쟁 해결 시스템** - Gemini 자동 중재 (<$100) + 마일스톤 freeze 기능
...
**문제**: 브랜드-크리에이터 간 지급/품질 분쟁
**해결**: 2단계 마일스톤 + 72시간 타임락 + 분쟁 시스템

| 마일스톤 | 금액 | 트리거 | 보호 효과 |
|---------|------|--------|----------|
| 계약금 | 20% | 크리에이터 수락 시 | 크리에이터 최소 보장, 노쇼 방지 |
| 최종 정산 | 80% | 콘텐츠 검증 + 72시간 타임락 만료 | 분쟁 기간 제공 + 자동 릴리즈 |

**72시간 타임락**: 계약금 지급 후 content 마일스톤에 타임락 적용 → 분쟁 제기 가능 기간
...
| 환불 문제 | 브랜드 일방적 환불 | 2단계 마일스톤 (20% deposit + 80% content) + 72시간 타임락 + 분쟁 시스템 |
